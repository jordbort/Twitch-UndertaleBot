...
module.exports = {
    getSpamtonQuote(props) {
        const { bot, channel, args } = props
        if (settings.debug) { console.log(`${boldTxt}> getSpamtonQuote(channel: ${channel}, args:`, args, `)${resetTxt}`) }
        ...
        idx >= 0 && idx < quotes.length && Number.isInteger(idx)
            ? bot.say(channel, quotes[idx])
